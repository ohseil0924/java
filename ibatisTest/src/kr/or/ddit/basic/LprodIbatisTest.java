...
//         System.out.println("select한 결과가 여러개 일 경우 ");
         ...
         // 이메서드는 여러개의 레코드 각각은 resultClass에 지정한 VO클래스에 
         //담은 후에 이 VO 클래스를 List에 추가해 주는 작업을 자동으로 수행한다 .
...
//        	 System.out.println("ID :" +lvo.getLprod_gu());
//        	 System.out.println("ID :" +lvo.getLprod_nm());
//        	 System.out.println("--------------------------------");
//         }
