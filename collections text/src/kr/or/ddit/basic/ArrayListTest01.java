...
public class ArrayListTest01 {
	...
	public static void main(String[] args) {
		//ArryaList는 기본적인 사용법이 Vector와 같다.
		...
		System.out.println("DDDDD값 존재여부  : " + list2.contains("DDDDD"));
		//존재유무 확인법
		System.out.println("ZZZZZ값 존재여부  : " + list2.contains("ZZZZZ"));
		//틀리면 FALSE로 나옴 
		System.out.println();
