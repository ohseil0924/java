...
//JDBC 드라이버를 로딩 하고 Connerction 객체를 생성하는
// 메서드로 구성된 class 만들기 
...
public class DBUtil3 {
   ...
   static{
      ...
      logger.info("ResourceBundle객체생성 - dbinfo.properties 파일 읽기");
   ...
   //DB 에 접속하고 접속에 성공하면 Connection 객체를 반환하는 메서드 
   public static Connection getConnection(){
      try {
         logger.trace("db에 접속중 ~~~");
